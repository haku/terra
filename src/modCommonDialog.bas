...
'i have been reusing this module for AGES.

'**************************************
' Name: Common Dialog
' Description:Use commondialog control without ocx !
...
Function SaveDialog(Form1 As Form, Filter As String, Title As String, InitDir As String) As String
    ...
    CD_FI = ofn.nFilterIndex
    f = Trim(ofn.lpstrFile)
    If f <> "" Then f = Mid$(f, 1, Len(f) - 1)
    If (a) Then
        SaveDialog = f
    Else
        SaveDialog = ""
...
Function OpenDialog(Form1 As Form, Filter As String, Title As String, InitDir As String) As String
    ...
    If (a) Then
        ...
        OpenDialog = Mid$(OpenDialog, 1, Len(OpenDialog) - 1)
    Else
        OpenDialog = ""
    End If
End Function
